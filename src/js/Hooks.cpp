...
void JSHooks::registerConsole(JSContext* ctx) {
	...
	JS_SetPropertyStr(ctx, console, "warn", JS_NewCFunction(ctx, hooks::console::warn, "warn", 1));
	JS_SetPropertyStr(ctx, console, "error", JS_NewCFunction(ctx, hooks::console::error, "error", 1));
